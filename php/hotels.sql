...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-03-2015 a las 20:11:13
...
CREATE TABLE IF NOT EXISTS `domicilios` (
  `id` int(11) NOT NULL,
  `direccion` varchar(300) COLLATE latin2_bin DEFAULT NULL,
  `colonia` varchar(200) COLLATE latin2_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `estados` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `idestados_UNIQUE` (`id`)
...
INSERT INTO `estados` (`id`, `idPais`, `estado`) VALUES
...
CREATE TABLE IF NOT EXISTS `habitaciones` (
  ...
  `tipo` varchar(300) COLLATE latin2_bin NOT NULL,
  `numeroHabitacion` varchar(20) COLLATE latin2_bin NOT NULL,
  `comentarios` varchar(500) COLLATE latin2_bin NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin2 COLLATE=latin2_bin;
...
INSERT INTO `habitaciones` (`id`, `precio`, `camas`, `tipo`, `numeroHabitacion`, `comentarios`) VALUES
(1, '0', 2, 'QNY50ESV5XP', 'urna et arcu imperdi', 'Keaton'),
(2, '0', 1, 'YGE98YJC4PW', 'nulla. Integer vulpu', 'William'),
(3, '0', 1, 'KAD91FRC4KC', 'dui. Suspendisse ac ', 'Driscoll'),
(4, '0', 3, 'VAD17CTN6WI', 'ut quam vel sapien i', 'Holmes'),
(5, '0', 1, 'LMJ39WSY7VW', 'urna. Nullam loborti', 'Joel'),
(6, '0', 1, 'UWV24PPC9PF', 'pellentesque eget, d', 'Joel'),
(7, '0', 1, 'RVU83VJK9SR', 'tincidunt pede ac ur', 'Emerson'),
(8, '0', 4, 'ARM51ZBJ8IJ', 'Suspendisse commodo ', 'Moses'),
(9, '0', 2, 'AOE63UJD8JZ', 'posuere cubilia Cura', 'Brent'),
(10, '0', 4, 'NGX11WRS0MP', 'eleifend. Cras sed l', 'Jack'),
(11, '0', 3, 'KIM84NBC1BH', 'ac nulla. In tincidu', 'Vernon'),
(12, '0', 1, 'PYI99SIS4FQ', 'euismod in, dolor. F', 'Wing'),
(13, '0', 3, 'VHK43CIV9DZ', 'imperdiet non, vesti', 'Paul'),
(14, '0', 3, 'XTM11ZSV5DJ', 'dui augue eu tellus.', 'Bruce'),
(15, '0', 2, 'NNG57YVT8YU', 'molestie tortor nibh', 'Dalton'),
(16, '0', 3, 'COQ36KDY3AZ', 'imperdiet ornare. In', 'Knox'),
(17, '0', 3, 'EXF84GIP3CM', 'sit amet ultricies s', 'William'),
(18, '0', 3, 'UPN33DJZ3LD', 'sapien. Aenean massa', 'Castor'),
(19, '0', 4, 'BGA03YOR1AK', 'condimentum eget, vo', 'Luke'),
(20, '0', 1, 'GZX41NGL8ZU', 'a mi fringilla mi la', 'Lyle'),
(21, '0', 1, 'UXH77DNM5NW', 'gravida non, sollici', 'Holmes'),
(22, '0', 3, 'KJP13TSE5HL', 'mi pede, nonummy ut,', 'Gary'),
(23, '0', 4, 'ZHP27NEB0RP', 'est tempor bibendum.', 'Rudyard'),
(24, '0', 2, 'LKN02JAC4ZZ', 'quis arcu vel quam d', 'Declan'),
(25, '0', 2, 'JTP18UBS7JO', 'rutrum, justo. Praes', 'Abel'),
(26, '0', 4, 'PMR39DFF1IH', 'Proin sed turpis nec', 'Vladimir'),
(27, '0', 3, 'BOV73PTJ1CT', 'ante dictum cursus. ', 'John'),
(28, '0', 1, 'DEU47TKV1BM', 'turpis egestas. Aliq', 'Eagan'),
(29, '0', 2, 'GBA27MZI6QA', 'aliquet, sem ut curs', 'John'),
(30, '0', 3, 'GRN54STG9FZ', 'est. Nunc ullamcorpe', 'Gavin'),
(31, '0', 4, 'VVF68BVH6SN', 'mauris, aliquam eu, ', 'Chaim'),
(32, '0', 1, 'DHO46KFW4ZN', 'ligula elit, pretium', 'Clayton'),
(33, '0', 4, 'UBQ62RJV5KW', 'varius ultrices, mau', 'Zeph'),
(34, '0', 2, 'ATP78RZS4VS', 'pellentesque. Sed di', 'Beau'),
(35, '0', 1, 'WCZ58CXL8EI', 'dapibus quam quis di', 'James'),
(36, '0', 2, 'IUB52QCH1ES', 'sodales purus, in mo', 'Akeem'),
(37, '0', 4, 'QTM63UEM4ZL', 'Curabitur sed tortor', 'Jerome'),
(38, '0', 1, 'UEY58QLP5LZ', 'purus. Duis elementu', 'Lyle'),
(39, '0', 4, 'JOF37PYU8DU', 'Phasellus nulla. Int', 'Jarrod'),
(40, '0', 4, 'SNW97CMT5PP', 'arcu. Morbi sit amet', 'Nathan'),
(41, '0', 1, 'DQX35DJO6DV', 'lobortis risus. In m', 'Quentin'),
(42, '0', 3, 'ZXO42LYJ5RN', 'sem egestas blandit.', 'Wing'),
(43, '0', 4, 'CSC94NND9FE', 'nec tempus mauris er', 'Lucas'),
(44, '0', 3, 'JPP51LIH0VG', 'libero est, congue a', 'Richard'),
(45, '0', 3, 'ZQP36KVJ9ZF', 'et magnis dis partur', 'Josiah'),
(46, '0', 3, 'DCP33EYS3DB', 'Suspendisse aliquet,', 'Wayne'),
(47, '0', 2, 'KDL44WKU4AE', 'adipiscing lacus. Ut', 'Damian'),
(48, '0', 4, 'FCQ17DNO3PZ', 'amet diam eu dolor e', 'Mufutau'),
(49, '0', 3, 'SMY13SXU2FB', 'ante. Nunc mauris sa', 'Melvin'),
(50, '0', 3, 'GMW23ULC4ZL', 'ligula. Nullam feugi', 'Channing'),
(51, '0', 2, 'FHH80LLW4PT', 'Sed diam lorem, auct', 'Uriah'),
(52, '0', 1, 'WHL23PPA5QR', 'arcu. Vestibulum ant', 'Adam'),
(53, '0', 3, 'PGV28CRH1GE', 'non, vestibulum nec,', 'Isaiah'),
(54, '0', 1, 'AGT89MAG9BT', 'diam. Sed diam lorem', 'Seth'),
(55, '0', 4, 'BMX90KWU7DV', 'ipsum. Curabitur con', 'Chadwick'),
(56, '0', 2, 'RSI48WTW6KA', 'Duis volutpat nunc s', 'Nigel'),
(57, '0', 2, 'CII80LPV2EQ', 'Nunc mauris sapien, ', 'Elliott'),
(58, '0', 4, 'QOL50YTO0NI', 'pharetra nibh. Aliqu', 'Clark'),
(59, '0', 2, 'XUV56DYR4CL', 'sem magna nec quam. ', 'Dennis'),
(60, '0', 3, 'AOB55MBE6ZK', 'urna. Vivamus molest', 'Jasper'),
(61, '0', 4, 'DCC18MZY3AN', 'sagittis lobortis ma', 'Coby'),
(62, '0', 4, 'EPR82SXC4ID', 'dui. Fusce diam nunc', 'Ahmed'),
(63, '0', 3, 'QHJ19JJA4OH', 'velit eget laoreet p', 'Tad'),
(64, '0', 3, 'VFV64OVJ0RS', 'est. Nunc laoreet le', 'Arthur'),
(65, '0', 2, 'RWJ53AHC8IK', 'ut dolor dapibus gra', 'Justin'),
(66, '0', 3, 'UQM24FZF6JG', 'neque sed sem egesta', 'Lucius'),
(67, '0', 1, 'PHS34YXQ7PK', 'sit amet, faucibus u', 'Grady'),
(68, '0', 1, 'DXW41HNP5XZ', 'Mauris quis turpis v', 'Patrick'),
(69, '0', 2, 'EWY78TGE7QI', 'sagittis augue, eu t', 'Orson'),
(70, '0', 3, 'HJJ63NIO0OR', 'In nec orci. Donec n', 'Garrett'),
(71, '0', 3, 'SXJ33UIO8MV', 'a ultricies adipisci', 'Conan'),
(72, '0', 4, 'BCT71XQQ1KA', 'et magnis dis partur', 'Isaiah'),
(73, '0', 1, 'QJB14PXS4KY', 'sed leo. Cras vehicu', 'Blake'),
(74, '0', 1, 'DUC65TBY5US', 'turpis egestas. Aliq', 'Kenneth'),
(75, '0', 2, 'RFK64CXO4ZP', 'et netus et malesuad', 'Tad'),
(76, '0', 4, 'TKQ75OQR7GP', 'pede sagittis augue,', 'Sylvester'),
(77, '0', 3, 'FNT40XGJ3AU', 'hendrerit id, ante. ', 'Harrison'),
(78, '0', 2, 'EZJ54DPW2LC', 'vulputate, risus a u', 'Quentin'),
(79, '0', 1, 'VQC30NNI5PM', 'et ipsum cursus vest', 'Alan'),
(80, '0', 2, 'UWF88HPY5EJ', 'nunc est, mollis non', 'Keegan'),
(81, '0', 3, 'IGM78XSQ7IM', 'mi. Aliquam gravida ', 'Nigel'),
(82, '0', 3, 'MLE33ISL8PF', 'dui augue eu tellus.', 'Elijah'),
(83, '0', 3, 'SHH46NTZ6SI', 'at, iaculis quis, pe', 'Mason'),
(84, '0', 2, 'VEN88CKY7AC', 'nunc id enim. Curabi', 'Isaiah'),
(85, '0', 3, 'LVH13GLL8JR', 'consectetuer rhoncus', 'Ivan'),
(86, '0', 4, 'USA75MCE9RD', 'nec tempus scelerisq', 'Raphael'),
(87, '0', 2, 'THM09BXM1XB', 'ut mi. Duis risus od', 'Colorado'),
(88, '0', 2, 'OGS20ZEB4FX', 'aliquam arcu. Aliqua', 'Warren'),
(89, '0', 3, 'ZOY53GFJ3XT', 'ipsum. Donec sollici', 'Gavin'),
(90, '0', 1, 'SGW96OKP6UO', 'metus. Aliquam erat ', 'Vaughan'),
(91, '0', 3, 'DFP10BJO1NC', 'ante blandit viverra', 'Barry'),
(92, '0', 3, 'ICV29SED5HM', 'eleifend nec, malesu', 'Chadwick'),
(93, '0', 3, 'EMX00RSO6FJ', 'eget, dictum placera', 'William'),
(94, '0', 4, 'JBU23GDJ7MI', 'diam lorem, auctor q', 'Kuame'),
(95, '0', 1, 'CSX33LWU2MN', 'Vivamus rhoncus. Don', 'Hammett'),
(96, '0', 1, 'SPI48GMP9OD', 'nec urna et arcu imp', 'Harper'),
(97, '0', 1, 'QKO74OSH9SH', 'tristique aliquet. P', 'Camden'),
(98, '0', 1, 'VRW41AFQ5JK', 'vehicula risus. Null', 'Peter'),
(99, '0', 4, 'VSM43IIK3UB', 'Duis risus odio, auc', 'Clark'),
(100, '0', 3, 'XWX41OVK1RB', 'Donec vitae erat vel', 'Lane');
...
CREATE TABLE IF NOT EXISTS `municipios` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `idmunicipios_UNIQUE` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `municipios` (`id`, `idEstado`, `municipio`) VALUES
(1, '1', 'Aguascalientes'),
(2, '1', 'Asientos'),
(3, '1', 'Calvillo'),
(4, '1', 'Cosío'),
...
CREATE TABLE IF NOT EXISTS `reservaciones` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `fk_rooms` (`idHabitacion`)
) ENGINE=InnoDB DEFAULT CHARSET=latin2 COLLATE=latin2_bin;
...
ALTER TABLE `reservaciones`
  ADD CONSTRAINT `reservaciones_ibfk_1` FOREIGN KEY (`idHabitacion`) REFERENCES `habitaciones` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
